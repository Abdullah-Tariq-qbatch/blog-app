...
import movie_logo from "../../assets/tvShowApp/movie_logo.png";
    ...
    <>
      <nav className=" border-gray-200 bg-gray-800 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <NavLink to="/tv-shows" className="flex items-center">
          ...
          <div
            ...
            id="navbar-search"
          >
            <NavLink to="/tv-shows" className={navButtonStyle}>
              Home
            </NavLink>

            <NavLink to="/tv-shows/add-tv-show" className={navButtonStyle}>
              Add TV Show
            </NavLink>
          </div>
        </div>
