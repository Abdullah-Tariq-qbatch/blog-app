      ...
      <div className="flex items-center justify-between flex-wrap mx-10">
        ...
        >
          <div className="text-sm lg:flex-grow">
            <Link to="/" className="block mt-4 lg:inline-block lg:mt-0 text-white-200 mr-4">Home</Link>
            <Link to="/create-blog" className="block mt-4 lg:inline-block lg:mt-0 text-white-200 mr-4">Write a Blog</Link>
          </div>
        </div>
      </div>
    </nav>
