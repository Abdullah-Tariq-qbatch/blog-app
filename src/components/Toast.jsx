  ...
  return (Blogs.success || Users.success || Comments.success || Blogs.error || Users.error || Comments.error) && show ? (
    <div className="fixed top-24 right-1 z-50">
      <div id="toast-success" className="flex items-center w-full max-w-xs p-4 mb-4  text-gray-500 dark:bg-gray-950 bg-white rounded-lg shadow" role="alert">
        ...
        <button type="button" onClick={handleClose} className="ml-auto -mx-1.5 -my-1.5 dark:bg-gray-950 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8" data-dismiss-target="#toast-success" aria-label="Close">
