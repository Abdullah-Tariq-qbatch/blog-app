...
function Footer() {
  return (
    <footer className="bg-gray-100 w-full shadow mt-20">
      <div className="w-full max-w-screen-xl mx-auto p/social-media4 md:py-8 flex flex-col justify-between h-full text-center">
        <div className="flex flex-col items-center justify-between lg:flex-row">
          ...
          <ul className="flex flex-wrap items-center mb-0 text-sm font-medium text-gray-700 sm:mt-5">
            ...
            <li>
              <NavLink to="/social-media" className="hover:underline">
                Contact
              </NavLink>
            </li>{" "}
          </ul>
