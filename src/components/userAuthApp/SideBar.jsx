    ...
    location.pathname !== "/login" && (
      ...
      >
        ...
        >
          ...
          <div className="flex flex-row items-center justify-around px-4 text-gray-800 dark:text-white">
            <h1 className="text-md px-2 py-4 text-center font-semibold md:text-xl">
              One App 2.0
            </h1>
          </div>

          <hr className="mx-2 border-gray-800 dark:border-white" />
            ...
            <ul className="flex flex-col justify-center space-y-4 p-2">
              <li>
                <Link
                  to={"/"}
                  onClick={toggleSidebar}
                  className="flex w-full cursor-pointer flex-row items-center justify-start space-x-2 rounded-md bg-gray-800 px-4 py-2 text-start text-gray-200 hover:bg-gray-950 hover:shadow-md dark:bg-gray-400 dark:text-gray-950 dark:hover:bg-gray-600"
                >
                  <HomeOutlined />
                  <p>Home</p>
                </Link>
