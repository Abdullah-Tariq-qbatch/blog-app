...
function Home() {
  return (
    <div className="bg-white dark:bg-gray-800">
      <div className="w-full h-48 sm:h-96 relative overflow-hidden  bg-no-repeat md:p-12 sm:p-5 flex justify-center  bg-center bg-cover" style={{ backgroundImage: `url(${cover})` }}>
